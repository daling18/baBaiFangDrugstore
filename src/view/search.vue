        ...
        <div class="header">
            <search-header>
                ...
                <form action="" slot="center">
                    <input type="text" placeholder="搜索药品名/症状" ref="input" v-model="value" @keydown.enter="search">
                    <input type="button">
                </form>
            </search-header>
        </div>
...
<style lang="scss" scoped>
    .search{
        ...
        .header{
            ...
            width: 25px;
            height: 25px;
            background: url(http://m.800pharm.com/images/wap/icon_w_close.png) no-repeat;
